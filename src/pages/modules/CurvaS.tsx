...
import { LineChart, Play, Rocket, RefreshCw, AlertTriangle, Rows, GitPullRequest, Table2 } from 'lucide-react'
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <ExportMenu
              ...
              columns={[
                ...
                { header: 'Planned Progress', accessor: r => r.plannedProgress ?? 0 },
                { header: 'Actual Progress', accessor: r => r.actualProgress ?? 0 },
                { header: 'Planned Cost', accessor: r => r.plannedCost ?? 0 },
                { header: 'Actual Cost', accessor: r => r.actualCost ?? 0 },
                { header: 'Planned Volume', accessor: r => r.plannedVolume ?? '' },
                { header: 'Actual Volume', accessor: r => r.actualVolume ?? '' },
              ]}
              filename={`CurvaS_${projectId}`}
              disabled={empty}
            />
