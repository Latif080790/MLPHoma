                    ...
                    extraContent={
                        <ExportMenu
                            ...
                            columns={[
                                ...
                                { header: 'Code', accessor: r => r.projectCode ?? '' },
                                { header: 'Status', accessor: r => r.status ?? '' },
                                { header: 'Budget', accessor: r => r.budget ?? 0 },
                                { header: 'CPI', accessor: r => r.stats?.cpi ?? '' },
                                { header: 'SPI', accessor: r => r.stats?.spi ?? '' },
                                { header: 'Progress %', accessor: r => r.stats?.overallProgress ?? '' },
                            ]}
