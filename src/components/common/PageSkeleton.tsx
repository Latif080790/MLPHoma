...
export function PageSkeleton() {
  return (
    <div className="min-h-screen bg-neutral-50 dark:bg-neutral-950">
      {/* Header skeleton */}
      <div className="h-14 border-b bg-card dark:bg-neutral-900 dark:border-neutral-800">
      ...
      <main className="mx-auto w-full max-w-7xl px-4 py-6 space-y-6">
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {[1, 2, 3, 4].map(i => (
            <div key={i} className="h-24 bg-card dark:bg-neutral-900 rounded-xl border dark:border-neutral-800 animate-pulse" />
          ))}
        </div>
        <div className="h-64 bg-card dark:bg-neutral-900 rounded-xl border dark:border-neutral-800 animate-pulse" />
      </main>
    </div>
  )
}
