  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-[0.97] active:transition-none",
  {
    variants: {
      variant: {
        ...
        outline:
          "text-primary border border-input bg-background shadow-sm hover:bg-accent hover:text-accent-foreground hover:-translate-y-px hover:shadow-md",
        secondary:
        ...
        brand:
          "bg-[#f97316] text-white font-semibold shadow-sm hover:bg-[#ea580c] hover:-translate-y-px",
      },
      size: {
        ...
        field: "h-11 px-6 text-base font-medium",
        touch: "h-12 rounded-md px-8 text-base font-bold",
        icon: "h-9 w-9",
      },
