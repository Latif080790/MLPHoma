                                    ...
                                    <tr key={risk.id} className="group border-t transition-colors hover:bg-muted/50">
                                        ...
                                        <td className="p-2.5 text-right">
                                            <div className="flex justify-end gap-1 opacity-80 transition-opacity md:opacity-0 md:group-hover:opacity-100 md:group-focus-within:opacity-100">
                                                <Button size="icon" variant="ghost" aria-label="Edit risiko" className="h-7 w-7" onClick={() => handleEdit(risk)}>
                                                    <Edit size={14} />
                                                </Button>
                                                <Button size="icon" variant="ghost" aria-label="Hapus risiko" className="h-7 w-7 text-red-500" onClick={() => handleDelete(risk)}>
                                                    <Trash2 size={14} />
                                                </Button>
                                            </div>
                                        </td>
