...
export function RABApprovalPanel({
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      toast.error('Failed to submit for approval', { description: (error as Error).message })
    }
  }
  ...
  const handleApprove = async () => {
    ...
    try {
      ...
      toast.error('Failed to approve', { description: (error as Error).message })
    }
  }
  ...
  const handleReject = async () => {
    ...
    try {
      ...
      toast.error('Failed to reject', { description: (error as Error).message })
    }
  }
