...
import { Boxes, CalendarDays, Package, TrendingUp, HardHat, Truck } from "lucide-react"
          ...
          <div className="flex flex-wrap gap-2">
            <ExportMenu
              ...
              columns={[
                ...
                { header: 'Total Cost', accessor: r => r.cost },
                { header: 'Material', accessor: r => r.material || 0 },
                { header: 'Labor', accessor: r => r.labor || 0 },
                { header: 'Equipment', accessor: r => r.equipment || 0 },
                { header: 'Other', accessor: r => r.other || 0 },
              ]}
              filename="Resource_Histogram"
            />
          </div>
        }
      />
                  ...
                  <CardContent>
                    <ResponsiveContainer width="100%" height={320}>
                      <BarChart data={histogram}>
                        ...
                        />
                        <Legend />
                        <Bar dataKey="material" name="Material" stackId="a" fill="#56B4E9" />
                        <Bar dataKey="labor" name="Labor" stackId="a" fill="#E69F00" />
                        <Bar dataKey="equipment" name="Equipment" stackId="a" fill="#009E73" />
                        <Bar dataKey="other" name="Other/Overhead" stackId="a" fill="#CC79A7" />
                      </BarChart>
                    </ResponsiveContainer>
