                ...
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                        ...
                        {hasBaseline && comparison && (
                            <Badge variant="outline" className={`text-[10px] h-5 ${comparison.variancePercent > 5 ? 'bg-red-100 text-red-700 dark:bg-red-900/30 dark:text-red-400' :
                    ...
                    <div className="space-y-4 mt-2">
                        ...
                        <div className="grid grid-cols-4 gap-3">
                            ...
                            <div className={`p-3 rounded-lg border text-center ${comparison.totalVariance > 0 ? 'border-red-200 bg-red-50/50 dark:border-red-900 dark:bg-red-950/20' :
                                ...
                                <p className="text-[10px] text-slate-500 uppercase font-semibold">Variance</p>
                            ...
                            <div className="p-3 rounded-lg border border-slate-200 dark:border-slate-800 text-center">
                                <p className="text-[10px] text-slate-500 uppercase font-semibold">Changes</p>
                                <div className="flex items-center justify-center gap-2 mt-1">
                                    {comparison.addedCount > 0 && (
                                        <span className="text-[10px] text-blue-600 font-semibold">+{comparison.addedCount}</span>
                                    )}
                                    {comparison.changedCount > 0 && (
                                        <span className="text-[10px] text-amber-600 font-semibold">~{comparison.changedCount}</span>
                                    )}
                                    {comparison.removedCount > 0 && (
                                        <span className="text-[10px] text-red-600 font-semibold">-{comparison.removedCount}</span>
                                    )}
                                    ...
                                    <Table>
                                        ...
                                        <TableBody>
                                            {comparison.items
                                                ...
                                                .map(v => (
                                                    <TableRow key={v.itemId} className="text-[11px] border-b border-slate-100 dark:border-slate-800">
