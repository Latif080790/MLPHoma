...
export function KeyboardShortcutsPanel() {
  ...
  return (
    ...
    >
      ...
      {/* Panel */}
      <div className="relative z-10 w-full max-w-2xl max-h-[85vh] overflow-y-auto rounded-2xl border border-border bg-card shadow-2xl animate-in fade-in-0 zoom-in-95 duration-200">
        {/* Header */}
        <div className="flex items-center justify-between px-6 py-4 border-b border-border">
          <div>
            ...
            <p className="text-xs text-muted-foreground mt-0.5">
              ...
              <kbd className="bg-muted/50 rounded px-1 font-mono text-xs">Esc</kbd>{' '}
              to close
            </p>
          </div>
          <button
            onClick={() => setOpen(false)}
            className="rounded-lg p-1.5 hover:bg-accent/40 transition-colors text-muted-foreground"
        ...
        <div className="px-6 py-3 border-t border-border bg-muted/30 rounded-b-2xl">
          <p className="text-xs text-muted-foreground text-center">
            Press{' '}
            <kbd className="bg-card border border-border rounded px-1 font-mono text-xs">Shift</kbd>
            {' + '}
            <kbd className="bg-card border border-border rounded px-1 font-mono text-xs">?</kbd>
