  ...
  return (
    <TooltipProvider>
      <div className={cn("flex items-center -space-x-2 isolate", className)}>
            ...
            <TooltipTrigger asChild>
              <div className="relative group cursor-default">
                <Avatar className={cn(
                  ...
                  <AvatarFallback className="bg-slate-100 dark:bg-slate-800 text-[10px] uppercase font-bold text-slate-500">
        ...
        {remainingCount > 0 && (
          <div className="flex items-center justify-center h-8 w-8 rounded-full bg-slate-100 dark:bg-slate-800 ring-2 ring-white dark:ring-slate-900 border border-slate-200 dark:border-slate-800 text-[10px] font-bold text-slate-500">
            +{remainingCount}
          </div>
        )}
      </div>
