            ...
            <CardContent className="h-[400px] w-full mt-4">
                <ResponsiveContainer width="100%" height="100%">
                    <ScatterChart margin={{ top: 20, right: 20, bottom: 40, left: 40 }}>
                        ...
                        {/* Quadrant Labels */}
                        <text x="75%" y="25%" fill="#10b981" fontSize="10" fontWeight="bold" opacity="0.4" textAnchor="middle">TARGET ZONE</text>
                        <text x="25%" y="25%" fill="#f59e0b" fontSize="10" fontWeight="bold" opacity="0.4" textAnchor="middle">BURN ZONE</text>
                        <text x="75%" y="75%" fill="#3b82f6" fontSize="10" fontWeight="bold" opacity="0.4" textAnchor="middle">DRIFT ZONE</text>
                        <text x="25%" y="75%" fill="#ef4444" fontSize="10" fontWeight="bold" opacity="0.4" textAnchor="middle">DANGER ZONE</text>
